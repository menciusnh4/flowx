...
:deep(.form-item-tags .el-form-item__label) {
  ...
  align-self: flex-start !important; /* 顶部对齐，防止因右侧内容变高而被拉伸到垂直居中 */
}
...
/* 覆盖 Radio Group，呈现高级清透双圆角滑动胶囊 */
.content-mode-switch :deep(.el-radio-group) {
  background: #f1f5f9 !important; /* 精致中性的浅灰色背景槽 */
  border: 1px solid #e2e8f0 !important;
  border-radius: 20px !important;
  padding: 2px !important;
  display: inline-flex !important;
  align-items: center !important;
  height: 30px !important; /* 强制高度与上方胶囊按钮相同 */
  box-sizing: border-box !important;
  vertical-align: middle !important;
}
.content-mode-switch :deep(.el-radio-button) {
  border: none !important;
...
.content-mode-switch :deep(.el-radio-button__inner) {
  border: none !important;
  background: transparent !important;
  color: #475569 !important; /* 未选中项：沉稳优雅的深灰字 */
  font-size: 11px !important;
  font-weight: 700 !important;
...
/* 激活选中的小滑块：醒目的品牌紫底 + 纯白文字（对比度拉满） */
.content-mode-switch :deep(.el-radio-button.is-active .el-radio-button__inner) {
  background: #6366f1 !important;
  color: #ffffff !important;
  font-weight: 700 !important;
...
/* 悬停状态 */
.content-mode-switch :deep(.el-radio-button:not(.is-active) .el-radio-button__inner:hover) {
  color: #6366f1 !important;
}
.content-mode-switch :deep(.el-radio-button:first-child .el-radio-button__inner),
.content-mode-switch :deep(.el-radio-button:last-child .el-radio-button__inner) {
  border-radius: 18px !important;
  border-left: none !important;
}
.content-mode-switch :deep(.el-radio-button__original-radio:focus + .el-radio-button__inner) {
